"""API for Destiny 2 Vendors bound to Home Assistant OAuth."""
...
class ConfigEntryAuth(my_pypi_package.AbstractAuth):
    """Provide Destiny 2 Vendors authentication tied to an OAuth2 based config entry."""
    ...
    def __init__(
        ...
        """Initialize Destiny 2 Vendors Auth."""
        self.hass = hass
        self.session = oauth_session
        super().__init__(self.session.token)

    def refresh_tokens(self) -> str:
        """Refresh and return new Destiny 2 Vendors tokens using Home Assistant OAuth2 session."""
